...
## Area-level models and geospatial data

- In our experience, geospatial data is much less predictive when aggregated

- We suggest using sub-area models when using geospatial data, if possible
  - Can even do household-level with geospatial data ("unit-context model")
...
- Explosion in ML methods over last two decades

- "Deep learning" e.g.
  - Convolutional neural networks (CNNs)
  - Vision transformers (similar architecture to LLMs!)

. . .

- Problem: many of these methods cannot produce standard confidence intervals/standard errors
  - NSOs hesitant to adopt with these

. . .

- Possible solution: XGBoost and a non-parametric (residual) bootstrap
...
![](saeassets/path1.png){width=75% fig-align="center"}
...
- Merfeld et al. (2025) shows:
  - XGBoost predictions more accurate than EBP when estimating sub-area models
  - XGBoost uncertainty more accurate than EBP when estimating sub-area models
  - XGBoost uncertainty smaller than EBP when estimating sub-area models
