...
- Today: starting easy!
  - Review of everyone's experiences with R/SAE
  - Hopes for the workshop? Goals?
  
. . .

- Tomorrow: Vector files (shapefiles)
...
- Yihui Xie, J. J. Allaire, and Garrett Grolemund have an awesome -- free! -- resource on R Markdown, [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/)
...
- You can add R inline code using the `r' operator.
  ...
  - There are `r format(nrow(flights), big.mark = ",")` rows in the flights data
````
